...
- Add a Hugo Docsy site to this repository using Docsy conventions and the prepared Dagger static-site scenario from `github.com/riftonix/daggerverse/scenarios/static-site`.
